...
import { Check, ArrowRight, LayoutTemplate, Crown, Server, HelpCircle, Users, CreditCard } from 'lucide-react'
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="mt-24 text-center border-t border-white/5 pt-16">
                    <p className="text-sm md:text-base text-gray-400 font-light">
                        Teknolojiyi işinizin kaldıraç noktası haline getirelim. <br className="md:hidden" />
                        <span className="text-white/60"> Sizin için en optimize sistem mimarisini birlikte kurgulayalım.</span>
                    </p>
                </div>
            </div>
        </section>
