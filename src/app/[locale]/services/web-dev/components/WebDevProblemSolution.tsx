...
import { AlertCircle, CheckCircle2, Zap, Shield, TrendingUp } from 'lucide-react'
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-20 max-w-3xl mx-auto space-y-6">
                    <div className="animate-split inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/[0.03] border border-white/[0.08] backdrop-blur-xl hover:border-cyan-500/30 transition-all cursor-default">
                        ...
                        <span className="text-[10px] font-black text-cyan-300/60 tracking-[0.3em] uppercase">Stratejik Dönüşüm</span>
                    </div>
                    <div className="space-y-4">
                        <h2 className="animate-split text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-[-0.02em]">
                            <span className="opacity-50 blur-[1px]">Web Sitesi Değil,</span> <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]">
                                İşinizi Taşıyan Bir Sistem Kurun
                            </span>
                        </h2>
                        <p className="animate-split text-white/50 text-lg md:text-xl font-medium">
                            Birçok proje yayına alınır. Azı gerçekten işin bir parçası haline gelir.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="relative bg-[#0f0505] border border-red-900/30 rounded-[30px] p-10 overflow-hidden">
                            ...
                            <div className="relative flex flex-col gap-6">
                                <div className="flex items-center gap-3 text-red-500/80">
                                    <AlertCircle size={24} />
                                    <div>
                                        <h3 className="text-2xl font-bold uppercase tracking-widest line-through decoration-red-500/50 decoration-2 leading-none">Bugünü Kurtaran Yapılar</h3>
                                        <p className="text-[10px] text-red-500/40 font-mono mt-1">(Kısa Vadeli, Şablon Çözümler)</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-4 pt-4 border-t border-red-900/20 flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] font-mono text-red-500/60 uppercase tracking-widest">Status: Sınırları Olan</span>
                                </div>
                            </div>
                            {/* Glitch Overlay */}
                            ...
                            <div className="relative flex flex-col gap-8">
                                <div className="flex items-center justify-between border-b border-white/5 pb-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-3xl font-bold text-white leading-none">Yarın İçin Tasarlanan Altyapı</h3>
                                            <p className="text-[10px] text-cyan-400 font-mono mt-2 tracking-widest uppercase">(Uzun Vadeli, Stratejik Sistemler)</p>
                                        </div>
                                    </div>
                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    {[
                                        { text: "Müşteriye Özel", icon: TrendingUp, desc: "İş modelinize göre kurgulanan mimari ve akışlar" },
                                        { text: "Gelecek Odaklı", icon: Zap, desc: "Kullanıcı, trafik ve özellik artışına hazır yapı" },
                                        { text: "Yüksek Verim", icon: Shield, desc: "Ekiplerin gerçekten kullanmak istediği paneller" },
                                        { text: "Entegre Yapı", icon: Zap, desc: "AI, otomasyon ve entegrasyonlara açık sistem" },
                                        { text: "Sürdürülebilir", icon: CheckCircle2, desc: "Kontrolü sizde olan, sürdürülebilir platform" }
                                    ].map((item, i) => (
                ...
                <div className="mt-20 text-center animate-split">
                    <p className="text-xl md:text-2xl text-white/40 font-light italic">
                        "İyi görünen bir site sizi temsil eder. <span className="text-white opacity-100 font-medium not-italic">Doğru kurgulanmış bir sistem işinizi büyütür.</span>"
                    </p>
                </div>
