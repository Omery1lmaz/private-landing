...
import { AiSearchFlow, SemanticContentFlow, TechnicalSeoFlow, MetricsFlow, LinkFlow, GlobalStyles } from './AiSeoVisualFlows';
...
export default function AiSeoFeatureVisual({ feature }: FeatureVisualProps) {
    const Icon = feature.icon;
    const renderVisual = () => {
        const props = { results: feature.results };
        switch (feature.id) {
            case 'ai-search': return <AiSearchFlow {...props} />;
            case 'content': return <SemanticContentFlow {...props} />;
            case 'technical': return <TechnicalSeoFlow {...props} />;
            case 'analytics': return <MetricsFlow {...props} />;
            case 'links': return <LinkFlow {...props} />;
