            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="mt-24 text-center border-t border-white/5 pt-16">
                    <p className="text-sm md:text-base text-gray-400 font-light">
                        Fiyatı değil, doğru büyüme stratejisini konuşuyoruz. <br className="md:hidden" />
                        <span className="text-white/60"> Detayları hedef pazarınıza ve rekabetinize göre birlikte netleştiriyoruz.</span>
                    </p>
                </div>
            </div>
        </section>
