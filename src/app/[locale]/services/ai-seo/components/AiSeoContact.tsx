...
export default function AiSeoContact() {
                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center max-w-7xl mx-auto">
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-lg md:text-xl text-white/50 max-w-lg leading-relaxed">
                            Organik büyüme yolculuğunuzda size rehberlik etmek için buradayız. Ücretsiz AI-SEO analizi için ilk adımı atın.
                        </p>

                        <div className="flex flex-wrap gap-6 pt-4">
                            <div className="flex items-center gap-3 text-white/50">
                                <div className="w-2 h-2 rounded-full bg-cyan-500 animate-pulse" />
                                <span className="text-sm">Yıllık Stratejik Destek</span>
                            </div>
                            <div className="flex items-center gap-3 text-white/50">
                                <div className="w-2 h-2 rounded-full bg-cyan-500 animate-pulse" />
                                <span className="text-sm">Ucretsiz AI Analizi</span>
                            </div>
                        </div>
                    </div>
                            ...
                            >
                                ...
                                <div className="relative flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            <h3 className="text-xl md:text-2xl font-bold text-white mb-2">Analizi Başlat</h3>
                                            <p className="text-base text-white/50">24 saat içinde donus yapiyoruz</p>
                                        </div>
                                    </div>
                                ...
                                {['10x', '100%', 'ROI'].map((stat, i) => (
                                    <div key={i} className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.06] text-center hover:border-cyan-500/20 transition-colors">
                                        ...
                                        <div className="text-xs text-white/40">
                                            {i === 0 ? 'Potansiyel' : i === 1 ? 'Sürdürülebilirlik' : 'Odaklı'}
                                        </div>
                                    </div>
                                ))}
                            </div>
