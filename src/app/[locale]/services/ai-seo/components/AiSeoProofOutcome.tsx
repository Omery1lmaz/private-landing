...
import { Zap, MousePointer, LayoutGrid, TrendingUp, CheckCircle2, ArrowRight, Bot, Search, Sparkles, Settings } from 'lucide-react'

gsap.registerPlugin(ScrollTrigger)

export default function AiSeoProofOutcome() {
    const sectionRef = useRef<HTMLElement>(null)

    const outcomes = [
        {
            label: "Görünürlük Otoritesi",
            title: "Sektörel Hakimiyet",
            desc: "Sadece sıralama değil, sektörünüzde en çok referans alınan ve güvenilen marka konumu. AI motorları için otorite tescili.",
            results: ["Domain otorite artışı", "Marka bilinirliği", "AI motoru referansı"],
            visual: "flow",
            icon: Bot,
            color: "cyan"
        },
        {
            label: "Kullanıcı Niyeti",
            title: "Doğru Trafik, Doğru Kitle",
            desc: "Tıklama odaklı değil, satın alma niyetine (Search Intent) göre optimize edilmiş stratejik kullanıcı akışı.",
            results: ["Yüksek dönüşüm oranı", "Daha nitelikli lead", "Düşük hemen çıkma"],
            visual: "focus",
            icon: MousePointer,
            color: "purple"
        },
        {
            label: "Teknik Kusursuzluk",
            title: "Hız & Performans",
            desc: "Arama motorlarının ve kullanıcıların sevdiği, saniyeler içinde açılan teknik mükemmellik ve SEO altyapısı.",
            results: ["Core Web Vitals başarısı", "Mobil uyumluluk", "Teknik hata temizliği"],
            visual: "structure",
            icon: Settings,
            color: "blue"
        },
        {
            ...
            desc: "Algoritma güncellemelerinden etkilenmeyen, üzerine katarak büyüyen organik görünürlük altyapısı.",
            results: ["Artan organik gelir", "Uzun vadeli istikrar", "Pazar payı genişlemesi"],
            visual: "scale",
            icon: TrendingUp,
            color: "emerald"
        }
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-24 md:mb-32 space-y-6">
                    ...
                    <p className="text-gray-400 max-w-2xl mx-auto text-lg md:text-xl font-light leading-relaxed">
                        Doğru kurgulanmış bir SEO sistemi sadece trafik getirmez, <br className="hidden md:block" />
                        <span className="text-white/80">işinizi arama ekosisteminde kalıcı kılar.</span>
                    </p>
                </div>
