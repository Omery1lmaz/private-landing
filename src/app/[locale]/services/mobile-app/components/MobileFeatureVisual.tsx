...
import { CrossPlatformFlow, SyncFlow, PerformanceFlow, OfflineFlow, TokensFlow, GlobalStyles } from './MobileVisualFlows';
...
export default function MobileFeatureVisual({ feature }: FeatureVisualProps) {
    const Icon = feature.icon;
    const renderVisual = () => {
        const props = { results: feature.results };
        switch (feature.id) {
            case 'cross-platform': return <CrossPlatformFlow {...props} />;
            case 'sync': return <SyncFlow {...props} />;
            case 'performance': return <PerformanceFlow {...props} />;
            case 'offline': return <OfflineFlow {...props} />;
            case 'tokens': return <TokensFlow {...props} />;
