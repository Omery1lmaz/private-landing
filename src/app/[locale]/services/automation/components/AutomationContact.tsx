                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center max-w-7xl mx-auto">
                    ...
                    <div className="space-y-8">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 backdrop-blur-sm">
                            ...
                            <span className="text-sm text-cyan-400 font-medium">Otonom Gelecek</span>
                        </div>
                        ...
                        <p className="text-lg md:text-xl text-white/50 max-w-lg leading-relaxed">
                            Manuel yüklerden kurtulun. İşinizi otonom bir yapıya taşımak için bugün bir strateji toplantısı planlayın.
                        </p>

                        <div className="flex flex-wrap gap-6 pt-4">
                            <div className="flex items-center gap-3 text-white/50">
                                <div className="w-2 h-2 rounded-full bg-cyan-500 animate-pulse" />
                                <span className="text-sm">7/24 Otonom İzleme</span>
                            </div>
                            <div className="flex items-center gap-3 text-white/50">
                                <div className="w-2 h-2 rounded-full bg-cyan-500 animate-pulse" />
                                <span className="text-sm">Gelişmiş AI Entegrasyonu</span>
                            </div>
                        </div>
                    </div>
                            ...
                            >
                                ...
                                <div className="relative flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            <h3 className="text-xl md:text-2xl font-bold text-white mb-2">Otomasyonu Başlat</h3>
                                            <p className="text-base text-white/50">Ücretsiz süreç analizi ile başlayın</p>
                                        </div>
                                    </div>
                                ...
                                {['200%', '0', '7/24'].map((stat, i) => (
                                    <div key={i} className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.06] text-center hover:border-cyan-500/20 transition-colors">
                                        ...
                                        <div className="text-xs text-white/40">
                                            {i === 0 ? 'Verimlilik Artışı' : i === 1 ? 'Hata Payı' : 'Aktif Çalışma'}
                                        </div>
                                    </div>
                                ))}
                            </div>
