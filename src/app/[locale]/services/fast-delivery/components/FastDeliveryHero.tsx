...
import { ArrowRight, Sparkles, Rocket, Zap, Clock, Timer } from 'lucide-react'
...
export default function FastDeliveryHero() {
    ...
    const content = {
        tr: {
            badge: "Süper Hızlı Teslimat & Çevik Süreçler",
            titlePart1: "Fikirden Ürüne",
            titleHighlight: "Rekor Sürede",
            subtitle: "Vakit kaybetmeyin. 14 gün içinde tam fonksiyonel MVP'nizi veya kurumsal çözümünüzü yayına alıyoruz. Hızımız, kalitemizden ödün vermez.",
            support: "Pazar taleplerine anında yanıt veren, yüksek tempolu geliştirme döngüsü.",
            ctaButton: "Zamana Karşı Yarışın",
            ctaMicro: "Projenizi 14 gün içinde nasıl tamamlayacağımızı konuşalım.",
            cards: [
                {
                    title: "Hyper-Sprint Mode",
                    text: "Süreci aylardan haftalara indiren yüksek yoğunluklu çalışma.",
                    icon: Zap
                },
                {
                    title: "Ready-to-Scale",
                    text: "Sadece hızlı değil, aynı zamanda büyümeye hazır mimari.",
                    icon: Rocket
                },
                {
                    title: "Day 1 Value",
                    text: "İlk günden itibaren çalışan ve değer üreten teslimat.",
                    icon: Timer
                },
                {
                    title: "Agile Feedback",
                    text: "Anlık geri bildirimlerle sürekli gelişen otonom akış.",
                    icon: Clock
                }
            ]
        },
        en: {
            badge: "Super-Fast Delivery & Agile Processes",
            titlePart1: "From Idea to Product",
            titleHighlight: "In Record Time",
            subtitle: "Don't waste time. We release your fully functional MVP or enterprise solution in just 14 days. Our speed never compromises quality.",
            support: "High-tempo development cycle that responds instantly to market demands.",
            ctaButton: "Race Against Time",
            ctaMicro: "Let's talk about completing your project in just 14 days.",
            cards: [
                {
                    title: "Hyper-Sprint Mode",
                    text: "High-intensity work that reduces timeline from months to weeks.",
                    icon: Zap
                },
                {
                    title: "Ready-to-Scale",
                    text: "Architecture that's not just fast, but also ready to grow.",
                    icon: Rocket
                },
                {
                    title: "Day 1 Value",
                    text: "Delivery that works and produces value from day one.",
                    icon: Timer
                },
                {
                    title: "Agile Feedback",
                    text: "Autonomous flow that evolves constantly with instant feedback.",
                    icon: Clock
                }
            ]
        }
