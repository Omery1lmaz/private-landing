...
import { ArrowUpRight, Sparkles, Zap, Timer } from 'lucide-react'

export default function FastDeliveryContact() {
                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center max-w-7xl mx-auto">
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-lg md:text-xl text-white/50 max-w-lg leading-relaxed">
                            Projenizi beklemek zorunda değilsiniz. Bugün konuşalım, 14 gün sonra ürününüzü piyasaya sürün.
                        </p>
