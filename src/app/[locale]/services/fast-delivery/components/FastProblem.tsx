...
export default function FastProblem() {
  const t = useTranslations('fast_delivery.problem')
  ...
  const problems = [
    { icon: Clock, key: 'problem1' },
    { icon: TrendingDown, key: 'problem2' },
    { icon: AlertTriangle, key: 'problem3' },
  ]
            ...
            {problems.map((problem, idx) => (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-red-500/10 flex items-center justify-center mb-4 group-hover:bg-red-500/20 transition-colors">
